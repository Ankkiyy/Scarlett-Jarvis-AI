...
__all__ = [
    'SpeechRecognizerState', 'SPSHT_OTHER', 'SVP_18', 'SPLEXICONTYPE',
    'DISPID_SPIAudioSizeTime', 'SpObjectTokenCategory',
    'DISPID_SRCERecognizerStateChange', 'SPAO_RETAIN_AUDIO',
    'SDTPronunciation', 'SVP_11', 'SPPS_Interjection',
    'ISpRecognizer3', 'DISPID_SGRsCommit', 'DISPID_SGRSTText',
    'DISPID_SVEWord', 'DISPID_SPACommit', 'SRSActiveAlways',
    'SREAudioLevel', 'DISPID_SpeechLexiconWords',
    'DISPID_SVIsUISupported', 'DISPID_SVEStreamStart',
    'DISPID_SPEs_NewEnum', 'SVF_None', 'DISPID_SGRSTType',
    'SpShortcut', 'SpMMAudioIn', 'SVESentenceBoundary',
    'SPLO_DYNAMIC', 'SPAR_Unknown', 'DISPID_SPRsItem',
    'DISPID_SAFGetWaveFormatEx', 'tagSTATSTG',
    'SDA_Consume_Leading_Spaces', 'DISPID_SGRsDynamic',
    'SpeechTokenShellFolder', 'SpeechTokenKeyFiles',
    'DISPID_SLWs_NewEnum', 'SPPS_Verb', 'SP_VISEME_20', 'SLODynamic',
    'DISPID_SOTSetId', 'SVSFPersistXML', 'DISPID_SMSADeviceId',
    'DISPID_SVSVisemeId', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SABufferNotifySize', 'SPINTERFERENCE_NONE',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_APP',
    'DISPID_SOTCDefault', 'SpCompressedLexicon',
    'SGDSActiveWithAutoPause', 'DISPID_SVESentenceBoundary',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechMemoryStream',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SLWsItem',
    'ISpeechPhraseReplacements', 'SAFTADPCM_44kHzStereo',
    'SAFTGSM610_8kHzMono', 'DISPID_SPAs_NewEnum',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPRuleChildren',
    'SAFTADPCM_22kHzMono', 'SPSEMANTICFORMAT',
    'DISPID_SpeechRecoResult', 'ISpeechRecoResultDispatch',
    'SREStreamStart', 'ISpeechObjectTokens', 'SREPrivate',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_19', 'SpWaveFormatEx',
    'SpeechGrammarTagDictation', 'DISPID_SpeechLexiconWord',
    'DISPID_SVAudioOutputStream', 'SPWT_DISPLAY',
    'SpeechVoicePriority', 'SpeechTokenKeyUI',
    'DISPID_SDKGetBinaryValue', 'SAFT22kHz8BitMono', 'SREStreamEnd',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SVDisplayUI',
    'DISPID_SRCEEndStream', 'DISPID_SOTsItem',
    'DISPID_SPRFirstElement', 'SVP_15', 'SP_VISEME_21',
    'SVSFNLPSpeakPunc', 'SVP_21', 'SVPOver',
    'DISPID_SOTGetDescription', 'SECHighConfidence', 'SGDSInactive',
    'DISPID_SRCESoundStart', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRCreateRecoContext', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SBSSeek', 'DISPID_SPRNumberOfElements', 'SPSInterjection',
    'DISPID_SGRSTransitions', 'SFTSREngine',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE2',
    'ISpStreamFormatConverter', 'SRERecoOtherContext',
    'SRERecognition', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SVSInputSentencePosition', 'SVP_20', 'SPRULESTATE',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVEBookmark',
    'DISPID_SPRuleParent', 'DISPID_SPRuleName', 'SPPHRASE',
    'SGRSTTTextBuffer', 'SGSEnabled', 'SPPHRASEELEMENT',
    'DISPID_SPCIdToPhone', 'SAFTCCITT_uLaw_22kHzStereo',
    'SRSEIsSpeaking', 'SpeechPropertyResponseSpeed',
    'SAFT8kHz16BitMono', 'DISPID_SVEPhoneme', 'SPPHRASEPROPERTY',
    'SAFT8kHz8BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'SpNotifyTranslator', 'SDTAlternates', 'ISpEventSource',
    'DISPID_SVSkip', 'DISPID_SRCEPhraseStart', 'SP_VISEME_0',
    'ISpeechAudioStatus', 'eLEXTYPE_MORPHOLOGY',
    'SpInProcRecoContext', 'STSF_AppData', 'SPWAVEFORMATTYPE',
    'eLEXTYPE_RESERVED10', 'SECFNoSpecialChars',
    'SPADAPTATIONRELEVANCE', 'SpeechCategoryAppLexicons',
    'ISpPhraseAlt', 'ISpeechPhraseInfo', 'DISPID_SRCEEnginePrivate',
    'DISPID_SLWLangId', 'SVSFIsFilename', 'SVEStartInputStream',
    'DISPID_SRGetFormat', 'SAFT24kHz8BitMono', 'ISpeechRecoContext',
    'ISpDataKey', 'DISPID_SPIRetainedSizeBytes', 'SPXMLRESULTOPTIONS',
    'DISPID_SPIAudioStreamPosition', 'DISPIDSPTSI_ActiveLength',
    'SpTextSelectionInformation', 'DISPID_SRCERecognition',
    'SPSMF_UPS', 'SVP_4', 'SPCT_SUB_DICTATION', 'SPFM_CREATE_ALWAYS',
    'SPPS_Modifier', 'eLEXTYPE_PRIVATE13', 'SPEI_MIN_TTS',
    'SPGRAMMARWORDTYPE', 'DISPID_SpeechRecoResultTimes',
    'SPSSuppressWord', 'SRSInactive', 'ISequentialStream',
    'DISPID_SPPName', 'DISPID_SPPId', '_ISpeechVoiceEvents',
    'SPPS_RESERVED4', 'SPFM_OPEN_READONLY', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechVoiceStatus', 'SP_VISEME_2', 'DISPID_SGRAttributes',
    'ISpeechVoiceStatus', 'SpeechAllElements', 'DISPID_SAEventHandle',
    'SPVPRI_NORMAL', 'SpeechDataKeyLocation', 'SPEI_VOICE_CHANGE',
    'SpeechWordType', 'DISPID_SPEEngineConfidence',
    'ISpeechObjectToken', 'eLEXTYPE_PRIVATE15', 'SpeechRecoEvents',
    'SDTLexicalForm', 'SPEI_END_SR_STREAM', 'SpMMAudioEnum',
    'DISPID_SpeechPhraseElements', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SDKDeleteKey', 'SRATopLevel', 'LONG_PTR',
    'SPBO_TIME_UNITS', 'SSSPTRelativeToEnd', '__MIDL_IWinTypes_0009',
    'eLEXTYPE_PRIVATE7', 'DISPID_SRRAudio', 'SPGRAMMARSTATE',
    'DISPID_SPRuleConfidence', 'DISPID_SPIGrammarId',
    'SPPARTOFSPEECH', 'DISPID_SDKSetLongValue', 'ISpStreamFormat',
    'DISPID_SBSWrite', 'DISPID_SpeechPhraseBuilder',
    'Speech_StreamPos_Asap', 'DISPID_SGRSTPropertyName',
    'SPEVENTSOURCEINFO', 'SPWORDPRONOUNCEABLE',
    'DISPID_SGRInitialState', 'DISPID_SGRClear',
    'DISPID_SGRSTPropertyId', 'SPINTERFERENCE_TOOFAST',
    'ISpNotifyTranslator', 'DISPID_SRCEFalseRecognition',
    'SAFT16kHz16BitMono', 'SPPHRASEREPLACEMENT', 'SPDKL_CurrentUser',
    'DISPID_SDKEnumValues', 'DISPID_SRCCreateResultFromMemory',
    'SPPS_NotOverriden', 'DISPID_SLGetPronunciations',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRIsUISupported',
    'DISPID_SLAddPronunciation', 'SPFM_CREATE', 'SPVPRI_OVER',
    'SpeechAudioFormatGUIDText', 'DISPID_SRCEBookmark',
    'SSFMCreateForWrite', 'DISPID_SGRsCount', 'SPCT_DICTATION',
    'DISPID_SPRules_NewEnum', 'DISPIDSPRG', 'SAFT24kHz8BitStereo',
    'DISPID_SVAudioOutput', 'SAFTText', 'SPAS_CLOSED',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechLexiconProns',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechRecognitionType',
    'SVSFIsNotXML', 'SVP_8', 'SPWORDLIST', 'SAFTADPCM_44kHzMono',
    'SPEI_PHRASE_START', 'SPEI_UNDEFINED', 'DISPID_SPRulesCount',
    'SRSEDone', 'SDTAll', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SPEAudioSizeTime', 'SPSERIALIZEDRESULT',
    ...
    'SPAUDIOSTATUS', 'DISPID_SRAudioInput',
    'DISPID_SVSInputWordLength', 'DISPID_SRProfile', 'SRCS_Enabled',
    'DISPID_SRGetPropertyString', 'SAFT11kHz8BitMono',
    'SAFT22kHz16BitStereo', 'SP_VISEME_6', 'SECFDefault',
    'SVEPrivate', 'DISPID_SPPValue', 'SVP_19', 'eWORDTYPE_DELETED',
    'SPPS_RESERVED2', 'SGDSActive', 'SAFT16kHz16BitStereo',
    'SDKLLocalMachine', 'STCInprocHandler', 'DISPID_SPPFirstElement',
    'eLEXTYPE_PRIVATE4', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SAFSetWaveFormatEx', 'ISpObjectToken', 'SPEI_PHONEME',
    'SPEI_SR_PRIVATE', 'ISpeechPhraseInfoBuilder', 'DISPID_SVVoice',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SPIProperties',
    'ISpEventSink', 'DISPID_SVGetAudioOutputs', 'SREFalseRecognition',
    'SPEI_SOUND_START', 'DISPID_SpeechLexicon', 'DISPID_SPAsItem',
    'DISPID_SRSetPropertyNumber', 'eLEXTYPE_PRIVATE19',
    'ISpeechPhraseReplacement', 'SPSVerb', 'DISPID_SRRPhraseInfo',
    'DISPID_SOTsCount', 'SRTExtendableParse',
    'DISPID_SOTCreateInstance', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPIEngineId', 'SPSHT_NotOverriden', 'SPWORD',
    'Speech_Max_Pron_Length', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTDataKey', 'DISPID_SPPNumberOfElements',
    'SAFTCCITT_uLaw_22kHzMono', 'SECFIgnoreWidth',
    'DISPID_SVGetVoices', 'ISpeechTextSelectionInformation',
    'SpeechRecoContextState', 'SAFTCCITT_ALaw_8kHzMono',
    'eLEXTYPE_PRIVATE18', 'DISPID_SGRSAddRuleTransition',
    'ISpeechLexiconWords', 'SPAUDIOOPTIONS',
    'DISPIDSPTSI_SelectionLength', 'SREInterference', 'SRTEmulated',
    'DISPID_SOTGetAttribute', 'SPRST_INACTIVE', 'SPEI_REQUEST_UI',
    'DISPID_SAFGuid', 'SVEViseme', 'SPVISEMES', 'DISPID_SVRate',
    'DISPID_SVPriority', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPBO_NONE', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SOTMatchesAttributes', 'DISPID_SLGetWords',
    'DISPID_SPELexicalForm', 'DISPID_SWFEChannels',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechPhraseElement', 'DISPID_SRGCmdLoadFromResource',
    'SINoise', 'SREAdaptation', 'DISPID_SAFType', 'SRARoot',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechAudioFormat', 'SPEI_RESERVED1',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SRAExport',
    'SPPS_LMA', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRCS_Disabled',
    'ISpeechPhraseElement', 'SpeechAudioProperties', 'STCLocalServer',
    'DISPID_SpeechPhraseReplacement', 'SRSActive',
    'DISPID_SRRSpeakAudio', 'SRADefaultToActive',
    'SPSERIALIZEDPHRASE', 'SpeechSpecialTransitionType', 'ISpStream',
    'DISPID_SRIsShared', 'eLEXTYPE_PRIVATE16', 'eLEXTYPE_PRIVATE20',
    'SPSNotOverriden', 'DISPID_SLPSymbolic', 'SPINTERFERENCE',
    'SAFTCCITT_uLaw_44kHzMono', 'SREHypothesis',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioFormatGUIDWave',
    'eLEXTYPE_USER', 'DISPID_SWFEBlockAlign',
    'DISPID_SRRSaveToMemory', 'DISPID_SPRs_NewEnum',
    'DISPID_SOTIsUISupported', 'DISPID_SASetState',
    'DISPID_SRGRecoContext', '_RemotableHandle',
    'SAFT8kHz16BitStereo', 'SPDKL_LocalMachine',
    'DISPID_SRSetPropertyString', 'IEnumString',
    'DISPID_SpeechRecoResult2', 'DISPID_SPEAudioTimeOffset',
    'SPDKL_DefaultLocation', 'DISPID_SPPs_NewEnum',
    'SAFT12kHz16BitMono', 'SDKLCurrentConfig',
    'DISPID_SPAStartElementInResult', 'SPEI_SOUND_END',
    'DISPID_SRCVoice', 'DISPID_SADefaultFormat',
    'SPEI_SR_RETAINEDAUDIO', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRCRequestedUIType', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SMSGetData', '_SPAUDIOSTATE', 'SAFT44kHz16BitMono',
    'DISPID_SOTCId', 'DISPID_SVSyncronousSpeakTimeout',
    'ISpNotifySink', 'DISPID_SBSFormat', 'SGSExclusive', 'SPAR_Low',
    'SpPhraseInfoBuilder', 'DISPID_SVResume',
    'DISPID_SPRuleNumberOfElements', 'SpeechCategoryVoices',
    'SPSHT_Unknown', 'SSTTTextBuffer', 'SpNullPhoneConverter',
    'SpeechStreamSeekPositionType', 'SpeechRunState',
    'SpeechUserTraining', 'DISPID_SpeechObjectTokens',
    'SAFTADPCM_11kHzMono', 'eLEXTYPE_PRIVATE1', 'STCAll', 'SPRULE',
    'SAFT22kHz8BitStereo', 'SpeechTokenContext',
    'DISPID_SVEEnginePrivate', 'SLTApp', 'SpVoice',
    'DISPID_SpeechXMLRecoResult', 'SASPause', 'SPSHORTCUTTYPE',
    'SVSFIsXML', 'SRTReSent', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVGetAudioInputs', 'SP_VISEME_9', 'ISpeechPhoneConverter',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRGId', 'DISPID_SRGCmdLoadFromFile', 'SGRSTTEpsilon',
    'SAFT12kHz8BitMono', 'SPGS_EXCLUSIVE', 'DISPID_SPAPhraseInfo',
    'SpeechMicTraining', 'eLEXTYPE_RESERVED9', 'SPEVENTENUM',
    'SPEI_SR_AUDIO_LEVEL', 'STCRemoteServer', 'SPEI_HYPOTHESIS',
    'IInternetSecurityMgrSite', 'SVSFParseAutodetect',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPIGetText',
    'ISpeechBaseStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechRecoContextEvents',
    'SpeechFormatType', 'ISpeechDataKey', 'SpStream',
    'SPEI_END_INPUT_STREAM', 'SAFTExtendedAudioFormat',
    'SpeechPropertyResourceUsage', 'SVP_12', 'ISpAudio',
    'DISPID_SRCSetAdaptationData', 'SINone', 'SREBookmark',
    'DISPID_SGRSTsCount', 'DISPID_SLPLangId',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SPRuleId',
    'SpeechRuleAttributes', 'SAFT11kHz8BitStereo',
    'ISpeechLexiconPronunciations', 'SpeechRegistryLocalMachineRoot',
    'SpeechTokenIdUserLexicon',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'ISpShortcut',
    'SPGS_ENABLED', 'DISPID_SVWaitUntilDone', 'SVSFUnusedFlags',
    'DISPID_SpeechPhraseProperties', 'SpeechInterference',
    'SP_VISEME_7', 'DISPID_SVEViseme', 'SP_VISEME_10',
    'SPVOICESTATUS', 'ISpeechMemoryStream',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVP_6',
    'DISPID_SPPChildren', 'SAFTGSM610_11kHzMono',
    'SREPropertyNumChange', 'DISPID_SDKGetStringValue',
    'DISPID_SVEAudioLevel', 'SGLexicalNoSpecialChars',
    'DISPID_SLPs_NewEnum', 'SPGS_DISABLED', 'SAFT32kHz8BitStereo',
    'DISPID_SABufferInfo', 'eLEXTYPE_RESERVED8',
    'DISPID_SPEAudioSizeBytes', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVSInputSentenceLength',
    'ISpObjectWithToken', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechWordPronounceable', 'SVP_9', 'DISPID_SRRTLength',
    'DISPID_SLPsItem', 'ISpeechRecoResult', 'SRSInactiveWithPurge',
    'DISPID_SRCPause', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechRegistryUserRoot', 'DISPID_SpeechAudio',
    'ISpeechLexiconWord', 'SPWT_PRONUNCIATION',
    'eLEXTYPE_VENDORLEXICON', 'SpeechRuleState', 'SPEI_INTERFERENCE',
    'DISPID_SRCResume', 'DISPID_SPEActualConfidence',
    'SPEI_RESERVED3', 'SRTAutopause', 'SPSMF_SAPI_PROPERTIES',
    'UINT_PTR', 'ISpMMSysAudio', 'eLEXTYPE_RESERVED7',
    'DISPID_SVStatus', 'DISPID_SASFreeBufferSpace', 'ISpNotifySource',
    'SGDSActiveUserDelimited', 'SP_VISEME_16', 'SVP_10',
    'DISPID_SGRs_NewEnum', 'DISPID_SOTRemove',
    'DISPID_SRCEInterference', 'SVEVoiceChange',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechRecognizer',
    'SpeechLoadOption', 'SPSModifier', 'DISPID_SpeechBaseStream',
    'SpPhoneConverter', 'SPCATEGORYTYPE', 'DISPID_SPRuleFirstElement',
    'DISPID_SPRulesItem', 'ISpGrammarBuilder', 'SPSNoun',
    'DISPID_SPERetainedSizeBytes', 'SPEI_RESERVED6',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechAudioFormat', 'SP_VISEME_5',
    'SRADynamic', 'SAFT16kHz8BitMono',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVSPhonemeId',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SpeechGrammarRule', 'DISPID_SVSLastBookmark',
    'SPEI_TTS_PRIVATE', 'SPRST_INACTIVE_WITH_PURGE', 'SPWF_INPUT',
    'SAFT12kHz16BitStereo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SGRSTsItem',
    'SPAS_RUN', 'ISpPhrase', 'DISPID_SASState', 'SVSFNLPMask',
    'SP_VISEME_13', 'SPTEXTSELECTIONINFO', 'DISPID_SAVolume',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPEDisplayAttributes', 'SAFTNonStandardFormat',
    'DISPID_SRGCmdSetRuleState', 'SVP_13', 'DISPIDSPTSI',
    'SPEI_MAX_SR', 'SpeechCategoryRecognizers',
    'DISPID_SpeechFileStream', 'DISPID_SASNonBlockingIO',
    'SRAInterpreter', 'DISPID_SRCEPropertyStringChange', 'SRAImport',
    'DISPID_SRGSetTextSelection', 'SP_VISEME_18',
    'ISpeechPhraseProperty', 'SVEWordBoundary', 'DISPID_SLWsCount',
    'SPVPRIORITY', 'DISPID_SRGState', 'SpAudioFormat',
    'DISPID_SpeechPhoneConverter', 'ISpRecoCategory', 'SVF_Emphasis',
    'SPAUDIOBUFFERINFO', 'DISPID_SWFEExtraData', 'eWORDTYPE_ADDED',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_RESERVED5',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechPhraseProperties',
    'DISPID_SGRsCommitAndSave', 'SPRST_ACTIVE', 'DISPID_SGRName',
    'DISPID_SAStatus', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechRecoContext', 'SP_VISEME_14', 'SVEBookmark',
    'SRAORetainAudio', 'SpeechEngineConfidence',
    ...
    'DISPID_SDKEnumKeys', 'SpMemoryStream', 'SPEI_TTS_BOOKMARK',
    'DISPID_SGRSRule', 'SPEI_SR_BOOKMARK', 'DISPID_SFSOpen',
    'DISPID_SPCPhoneToId', 'DISPID_SPIElements', 'DISPID_SLPType',
    'SREPropertyStringChange', 'SDTRule', 'SpeechDiscardType',
    'SITooQuiet', 'DISPID_SPERequiredConfidence', 'SPAO_NONE',
    'SECLowConfidence', 'DISPID_SGRsFindRule', 'ISpeechPhraseRule',
    'SDKLCurrentUser', 'SpeechCategoryAudioOut',
    'DISPID_SABIBufferSize', 'SREAllEvents', 'ISpRecoGrammar2',
    'SITooLoud', 'SPAS_STOP', 'SAFT44kHz16BitStereo',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRGReset',
    'SDA_Two_Trailing_Spaces', 'SpeechGrammarTagWildcard',
    'ISpPhoneticAlphabetConverter', 'SAFT12kHz8BitStereo',
    'SPCT_COMMAND', 'SpeechLexiconType', 'SPFM_NUM_MODES',
    'SAFTNoAssignedFormat', 'ISpeechRecoResultTimes',
    'DISPID_SpeechAudioStatus', 'DISPID_SRCCreateGrammar',
    'DISPID_SPEDisplayText', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCEAdaptation', 'SpeechGrammarState',
    'DISPID_SLPPhoneIds', 'SpObjectToken', 'SPPS_RESERVED3',
    'SAFTADPCM_8kHzMono', 'eLEXTYPE_PRIVATE3', 'ISpRecoResult',
    'SSFMCreate', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SREmulateRecognition', 'SPRST_NUM_STATES',
    'SpeechEngineProperties', 'IEnumSpObjectTokens',
    'ISpeechCustomStream', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SGRSTWeight', 'SDTAudio', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechObjectToken', 'ISpeechAudio', 'DISPID_SOTCategory',
    'SPRST_ACTIVE_ALWAYS', 'SpeechEmulationCompareFlags',
    'DISPIDSPTSI_ActiveOffset', 'SpeechPartOfSpeech',
    'SpeechVoiceEvents', 'ISpVoice', 'SLTUser',
    'ISpeechRecognizerStatus', 'SGRSTTRule', 'DISPID_SpeechVoice',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SRCRecognizer',
    'SDKLDefaultLocation', 'DISPID_SRRTimes',
    'DISPID_SpeechLexiconPronunciation', 'WAVEFORMATEX',
    'SVSFPurgeBeforeSpeak', 'eLEXTYPE_PRIVATE6', 'SpInprocRecognizer',
    'SPCT_SUB_COMMAND', 'SPDATAKEYLOCATION', 'ISpXMLRecoResult',
    'DISPID_SVSLastResult', 'SPVPRI_ALERT', 'IStream',
    'ISpeechGrammarRule', 'DISPID_SRCEAudioLevel',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SOTRemoveStorageFileName',
    'SAFT32kHz8BitMono', 'SPLO_STATIC', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_WORD_BOUNDARY', 'SPEI_PROPERTY_STRING_CHANGE', 'SPSLMA',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SOTId', 'ISpRecoContext',
    'ISpPhoneConverter', 'DISPID_SDKGetlongValue',
    'DISPID_SPEPronunciation', 'DISPID_SPIReplacements',
    'ISpeechXMLRecoResult', 'SPRS_ACTIVE', 'Speech_Max_Word_Length',
    'DISPID_SASCurrentSeekPosition',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTGSM610_44kHzMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT16kHz8BitStereo', 'DISPID_SPANumberOfElementsInResult',
    'SpeechAudioVolume', 'STCInprocServer', 'SpCustomStream',
    'DISPID_SRGCommit', 'SAFT48kHz8BitMono', 'SASClosed',
    'SRERequestUI', 'SGSDisabled', 'DISPID_SDKCreateKey',
    'SpSharedRecognizer', 'ISpeechWaveFormatEx', 'DISPID_SVPause',
    'SVF_Stressed', 'SVP_14', 'SECFIgnoreKanaType', 'SpLexicon',
    'SpUnCompressedLexicon', 'STSF_LocalAppData', 'SSTTDictation',
    'eLEXTYPE_USER_SHORTCUT', 'SFTInput', 'SPAUDIOSTATE',
    'ISpeechRecoGrammar', 'SP_VISEME_12', 'SASRun',
    'DISPID_SpeechVoiceEvent', 'SpeechPropertyLowConfidenceThreshold',
    'ISpObjectTokenCategory', 'DISPID_SRCBookmark', 'SDTProperty',
    'DISPID_SPRsCount', 'SVEPhoneme', 'SLOStatic',
    'DISPID_SRCESoundEnd', 'SSFMOpenForRead',
    'ISpeechPhraseAlternates', 'SVPNormal', 'DISPID_SRRRecoContext',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVVolume',
    'DISPID_SLGenerationId', 'DISPID_SGRId', 'SPRS_INACTIVE',
    'SPFM_OPEN_READWRITE', 'DISPID_SGRSTPropertyValue', 'SWTDeleted',
    'SPRS_ACTIVE_USER_DELIMITED', 'ISpResourceManager',
    'DISPID_SDKOpenKey', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRRSetTextFeedback', 'SPEI_MAX_TTS',
    'DISPID_SPILanguageId', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SpeechPhraseRule', 'SPAR_High', 'DISPID_SMSALineId',
    'SPWORDPRONUNCIATIONLIST', 'SECNormalConfidence', 'SPPHRASERULE',
    'ISpeechAudioBufferInfo', 'SAFT32kHz16BitStereo', 'SPAR_Medium',
    'SVSFParseSapi', 'SAFTADPCM_22kHzStereo', 'DISPID_SRSClsidEngine',
    'DISPID_SVEVoiceChange', 'SPSUnknown', 'SGLexical',
    'DISPID_SGRSTNextState', 'SPBINARYGRAMMAR', 'SGDisplay',
    'ISpeechGrammarRuleStateTransitions',
    'SpPhoneticAlphabetConverter', 'SAFTCCITT_ALaw_22kHzMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechRetainedAudioOptions',
    '_ISpeechRecoContextEvents', 'SPSHT_EMAIL',
    'DISPID_SRGetPropertyNumber', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SABIEventBias', 'DISPID_SWFEFormatTag',
    'DISPID_SVSLastStreamNumberQueued', 'SPSHORTCUTPAIR',
    'SP_VISEME_8', 'DISPID_SRSNumberOfActiveRules', 'SVEAllEvents',
    'SWPUnknownWordPronounceable', 'STSF_FlagCreate',
    'DISPID_SPEsItem', 'ISpeechVoice', 'SPSEMANTICERRORINFO',
    'SPPS_Noncontent', 'SPEI_RESERVED2', 'SAFT44kHz8BitStereo',
    'SDTDisplayText', 'DISPID_SDKSetBinaryValue',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SP_VISEME_17',
    'SPPS_RESERVED1', 'DISPID_SRCAudioInInterferenceStatus',
    'SpSharedRecoContext', 'SASStop', 'DISPID_SPCLangId',
    'SpeechDisplayAttributes', 'SPWF_SRENGINE', 'SP_VISEME_3',
    'SpeechAudioState', 'DISPID_SRCEStartStream',
    'DISPID_SLPPartOfSpeech', 'SVP_0', 'SPEI_RECOGNITION',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SMSSetData',
    'SREPhraseStart', 'SAFT24kHz16BitMono', 'SPPROPERTYINFO',
    'SPPS_Noun', 'SREStateChange', 'DISPID_SPRText', 'ISpProperties',
    'SECFEmulateResult', 'ISpRecoContext2',
    'SpeechCategoryPhoneConverters', 'SPCONTEXTSTATE',
    'DISPID_SLWPronunciations', 'ISpeechLexiconPronunciation',
    'SpFileStream', 'SAFTADPCM_8kHzStereo', 'SINoSignal',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVSpeakStream',
    'SpeechVoiceSpeakFlags', 'SPCT_SLEEP', 'DISPID_SRGDictationLoad',
    'DISPID_SPARecoResult', 'SPRECOCONTEXTSTATUS', 'DISPID_SPAsCount',
    'SP_VISEME_15', 'eLEXTYPE_PRIVATE9', 'DISPID_SABIMinNotification',
    'SPSHORTCUTPAIRLIST', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRCERequestUI', 'SPEI_START_SR_STREAM',
    'DISPID_SGRAddResource', 'DISPID_SCSBaseStream',
    'DISPID_SRGRules', 'SVSFDefault', 'SVPAlert', 'SVEAudioLevel',
    'SDA_No_Trailing_Space', 'DISPID_SRRTOffsetFromStart', 'SBOPause',
    'DISPID_SBSRead', 'SpMMAudioOut', 'SAFTADPCM_11kHzStereo',
    'SPBOOKMARKOPTIONS', 'ISpeechPhraseRules', 'SVP_16',
    'DISPID_SRCState', 'DISPID_SOTCGetDataKey', 'SBONone',
    'SVSFVoiceMask', 'DISPID_SRRGetXMLResult', 'SAFT48kHz16BitMono',
    'SpeechVisemeType', 'SpeechAddRemoveWord', 'SVP_17',
    'ISpeechMMSysAudio', 'DISPID_SPIRule', 'SVSFParseMask',
    'SAFT24kHz16BitStereo', 'SAFT32kHz16BitMono', 'SPEI_VISEME',
    'SPINTERFERENCE_NOISE', 'SpResourceManager',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SpeechGrammarRules',
    'SPEI_START_INPUT_STREAM', 'DISPID_SPPsCount',
    'SAFT22kHz16BitMono', 'SGRSTTDictation', 'SpeechStreamFileMode',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpeechTokenValueCLSID',
    'SAFTDefault', 'SDTReplacement', 'SpeechDictationTopicSpelling',
    'ISpeechRecoResult2', 'SpeechGrammarWordType', 'SSTTWildcard',
    'SVP_7', 'SpeechCategoryAudioIn', 'SPCS_ENABLED',
    'DISPID_SOTs_NewEnum', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechRecognizer', 'DISPID_SRAudioInputStream',
    'ISpeechPhraseAlternate', 'DISPID_SGRSTRule', 'SPPS_Function',
    'SGRSTTWord', 'Speech_StreamPos_RealTime', 'DISPID_SPPConfidence',
    'SWPKnownWordPronounceable', 'SpeechRecoProfileProperties',
    'DISPID_SPRuleEngineConfidence', 'SPSTREAMFORMATTYPE',
    'DISPID_SDKSetStringValue', 'ISpRecognizer2',
    'DISPID_SVEventInterests', 'DISPID_SRSCurrentStreamPosition',
    'SPRECOSTATE', 'SpStreamFormatConverter',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SSSPTRelativeToStart',
    'DISPID_SpeechPhraseProperty', 'SP_VISEME_4',
    'ISpeechGrammarRuleState', 'DISPID_SOTCSetId',
    'DISPID_SVSRunningState', 'DISPID_SVSLastBookmarkId',
    'DISPID_SLPsCount', 'SGRSTTWildcard', 'DISPID_SVEStreamEnd',
    'SAFTCCITT_ALaw_22kHzStereo', 'SpeechCategoryRecoProfiles',
    'SPRECORESULTTIMES', 'SRESoundEnd', 'SP_VISEME_1',
    'DISPID_SGRAddState', 'SPDKL_CurrentConfig', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPParent', 'SVP_3',
    'Speech_Default_Weight', 'SPEI_MIN_SR', 'DISPID_SRStatus',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechObjectTokenCategory',
    'SPBO_PAUSE', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRCRetainedAudio', 'SVEEndInputStream', 'SPWORDTYPE',
    'SPAS_PAUSE', 'SP_VISEME_11', 'SPEVENT', 'SPPS_SuppressWord',
    'eLEXTYPE_PRIVATE8', 'SITooFast', 'ISpeechGrammarRules',
    'SVSFParseSsml', 'SpeechBookmarkOptions',
    'DISPID_SWFEBitsPerSample', 'SPBO_AHEAD', 'ISpLexicon',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SVAlertBoundary',
    'DISPID_SPEsCount', 'SpeechGrammarRuleStateTransitionType',
    'SVP_2', 'DISPID_SVSpeak', 'SPSFunction', 'SPWT_LEXICAL',
    'DISPID_SASCurrentDevicePosition', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPPS_Unknown', 'SITooSlow', 'SPRECOGNIZERSTATUS',
    'SpeechTokenKeyAttributes', 'SPXRO_SML', 'ISpRecoGrammar',
    'SAFT48kHz8BitStereo', 'SpeechPropertyAdaptationOn',
    'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE10', 'SECFIgnoreCase',
    'STSF_CommonAppData', 'SRTStandard', 'DISPID_SRGIsPronounceable',
    'DISPID_SRGDictationUnload', 'ISpeechPhraseElements',
    'DISPID_SMSAMMHandle', 'DISPID_SPPsItem',
    'DISPID_SRSSupportedLanguages', 'DISPID_SGRsAdd', 'SVSFlagsAsync',
    'DISPID_SRRecognizer', 'SAFT44kHz8BitMono', 'ISpRecognizer',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechDataKey', 'DISPID_SLWType',
    'ISpSerializeState', 'SpeechAudioFormatType', 'tagSPPROPERTYINFO',
    'DISPID_SVGetProfiles', 'SRTSMLTimeout',
    'DISPID_SLRemovePronunciation', 'DISPID_SRState',
    'DISPID_SRRTStreamTime', 'SPFILEMODE', 'DISPID_SRRAudioFormat',
    'SSFMOpenReadWrite', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SpeechCustomStream', 'eLEXTYPE_RESERVED6',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SRSAudioStatus',
    'DISPID_SGRsItem', 'ISpeechFileStream', 'DISPID_SDKDeleteValue',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPCS_DISABLED',
    'DISPID_SLGetGenerationChange', 'SVP_1', 'SDA_One_Trailing_Space',
    'DISPID_SPISaveToMemory', 'SPXRO_Alternates_SML', 'SPLOADOPTIONS',
    'DISPID_SFSClose', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPPEngineConfidence', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRDisplayUI',
    'ISpeechLexicon', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRRAlternates', 'SGPronounciation', 'SAFT8kHz8BitMono',
    'SPEI_ADAPTATION', 'SAFT11kHz16BitStereo', 'SVP_5',
    'ISpeechResourceLoader', 'DISPID_SRRTTickCount',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPRDisplayAttributes', 'ISpeechGrammarRuleStateTransition'
]

_check_version('1.2.0', 1696997438.616660)
